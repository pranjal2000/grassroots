...
export class AppHome {
  ...
  render() {
    ...
    var img2 = 'url(' + this.ngo.photos[8] + ')';
    return [
      <ion-content>
        ...
        <section id="hero" class="section">
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="herotext">
                  ...
                  <p>
                    <a href="/projects" class="btn btn-default btn-lg wow fadeInLeft" role="button"> Our Projects </a>
          ...
          <div class="container mt-2">
            <div class="custom-headline text-center"><br />
              <h3 class="section-title"><strong>Media <span class="lighter">Coverage</span></strong></h3><br />

            </div>

            { this.ngo.media.length > 0 ?
            <div class="col-md-12 text-center service-box">
              {this.ngo.media.slice(0, 6).map(m => (
              <div class="col-md-4 col-sm-4">
                <div class="card card-block">
                  <a href={m.link}><img src={m.photo.url} alt="media 1" /></a>
                  <h5 class="card-title mt-3 mb-3">{ m.name.length < 40 ? m.name : m.name.substring(0, 40) + '...'
                      }</h5> <p class="card-text">{ m.description.length < 60 ? m.description :
                        m.description.substring(0, 60) + '...' } </p> {/* <span class="text-center"> { new
                        Date(m.date._seconds * 1000).toLocaleDateString("en-US") } </span> */}
                </div>
              </div> )) }
            </div>: null }

                ...
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6">
                    <div class="service-box wow flipInY" data-wow-duration="1.5s" data-wow-delay="0.1s">
                      ...
                      <div class="text-center">
                        ...
                        {/* <p>
                          I will place all the necessary content for this event here, including where they can register,
                          join, attend &amp; so on.
                        </p>
                        <p>
                  ...
                  <div class="col-md-4 col-sm-6">
                    <div class="service-box wow flipInY">
                      ...
                      <iframe style={{ 'width': '100%', 'min-height': '320px' }}
                        src={`https://www.youtube.com/embed/${this.ngo.video.url.split('?v=')[1]}`} frameborder="0"
                        allowFullScreen
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div class="col-md-4 service-block col-sm-6">
                    <div class="card card-block">
                      ...
                      <h2 class="card-title mt-3 mb-3">{ m.name.length < 40 ? m.name : m.name.substring(0, 40) + '...'
                          }</h2> <p class="card-text">{ m.role.length < 60 ? m.role : m.role.substring(0, 60) + '...' }
                            </p> <p>
                            ...
                            {/* <span class="text-center"> { new Date(m.date._seconds *
                              1000).toLocaleDateString("en-US") } </span> */}
                    </div>
                  </div> )) }
                </div>: null }
